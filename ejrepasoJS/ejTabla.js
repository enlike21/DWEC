...
posiciontabla.addEventListener("click", (event) => {
    let tabla = document.getElementById("tabla");
    if (event.target.tagName== "TD") {
        let fila = event.target.parentNode;

        // Duplicar la fila
        let filaDuplicada = fila.cloneNode(true);

        // Mover la fila duplicada al final de la tabla
        tabla.appendChild(filaDuplicada);
